...
public class SavedOfferAdapter extends RecyclerView.Adapter<SavedOfferAdapter.OffreViewHolder> {

    ArrayList<ManageOffers> offres = new ArrayList<>();
    RecycleViewOnItemClick recycleViewOnItemClick;

    public SavedOfferAdapter(ArrayList<ManageOffers> offres, RecycleViewOnItemClick recycleViewOnItemClick) {
        this.offres = offres;
